...
- **Report export:** In the *Generated Files* table you can **Preview / Download / Copy** `unknown_report.json` and `partial_report.json` (unknown report is generated even when `addMissingItems` is disabled)

...
def gen_building():
    ...
    def get_co_by_functiontext(cos,config_functiontexts,checkwriteflag=True):
        """Get communication Object by FunctionText"""
    ...
    #     if "communication_object" in cos:
    #         for co in cos["communication_object"]:
    #             itemco=get_from_dco(co,config_functiontexts)
    #             if itemco is not None:
    #                 return itemco
    #     return None
    def get_from_dco(co,config_functiontexts):
        """Gets (lowest) communication Object from the device communicatin Objects in the same Channel (old: with the same 'text')"""

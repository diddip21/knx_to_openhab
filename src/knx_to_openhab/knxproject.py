"""Module for reading a knx file and generating a house structure for transfer to generator"""
import logging
import re
import json
import argparse
...
def main():
    ...
    generator.GWIP = ip
    generator.B_HOMEKIT = homekit_enabled
    generator.B_ALEXA = alexa_enabled
    if prj_name:
        generator.PRJ_NAME = prj_name

    logger.info("Calling generator.main()")
    generator.main()

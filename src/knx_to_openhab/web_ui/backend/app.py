...
if FLASK_AVAILABLE:
    ...
    def get_config():
        ...
        try:
            ...
            main_config_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'config.json')
            with open(main_config_path, 'r', encoding='utf-8') as f:
                main_config = json.load(f)
    ...
    def project_preview():
        ...
        try:
            ...
            # FIX 1: Use relative import instead of dynamic import
            from ... import knxproject as knxmod
    ...
    def job_preview(job_id):
        ...
        try:
            ...
            # Extract project metadata
            # FIX 2: Use relative import instead of dynamic import
            from ... import knxproject as knxmod

...
class TestInstallerScript(unittest.TestCase):
    ...
    def test_setup_script_has_shebang(self):
        ...
        self.assertTrue(
            ...
            "Setup script missing shebang"
        )
        self.assertIn(
            "bash", first_line.lower(),
            "Shebang should reference bash"
        )
    ...
    def test_setup_script_required_commands(self):
        ...
        for cmd in required_commands:
            self.assertIn(
                cmd, content,
                f"Setup script should use '{cmd}' command"
            )
    ...
    def test_backup_cleanup_script_exists(self):
        ...
        self.assertTrue(
            ...
            "Backup cleanup script not found"
        )
        # Check if executable
    ...
    def test_readme_exists_in_installer(self):
        ...
        self.assertTrue(
            readme.exists(),
            "README.md not found in installer directory"
        )
        ...
        self.assertGreater(
            len(content), 100,
            "README.md seems too short (less than 100 characters)"
        )

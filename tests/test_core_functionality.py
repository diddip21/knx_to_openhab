"""Unit tests for core functionality not currently tested.
...
class TestGetCoFlags:
    ...
    def test_get_co_flags_partial_present(self):
        ...
        co = {"flags": {"read": True, "write": False}}
...
class TestIntegrationScenarios:
    ...
    def test_combined_processing_for_knx_device(self):
        ...
        command_co = {
            "text": "Dimmer Command",
            "flags": {"read": False, "write": True, "transmit": False, "update": False},
            "dpts": [{"main": 3, "sub": 7}],  # Dimming control DPT
        }

        status_co = {
            "text": "Dimmer Status",
            "flags": {"read": True, "write": False, "transmit": True, "update": True},
        ...
        assert (
            flags_match(status_flags, {"transmit": True}) is True
        )  # Should be transmittable
